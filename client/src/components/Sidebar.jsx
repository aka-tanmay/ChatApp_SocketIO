     ...
     <div className='pb-5'>
      <div className='flex justify-between items-center'>
        ...
        <div className="relative py-2 group">
           ...
           <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border border-gray-600 text-gay-100 hidden group-hover:block'>
      ...
      <div className='flex flex-col'>
        {filteredUsers.map((user,index)=>(
          ...
          'bg-[#282142]/50 '}`}>
              ...
              right-4 text-xs h-5 w-5 flex justify-center 
